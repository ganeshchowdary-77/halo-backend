...
class QuotePricingServiceTest {
    ...
    void calculatePersonalizedPremium_ShouldAlwaysBeGreaterThanOrEqualToBase_SmallInfluencer() {
        ...
        BigDecimal premium = quotePricingService.calculatePersonalizedPremium(testProduct, profile);
    ...
    void calculatePersonalizedPremium_ShouldBeHigher_ForHighRiskNiche() {
        ...
        BigDecimal cryptoPremium = quotePricingService.calculatePersonalizedPremium(testProduct, cryptoProfile);
        BigDecimal lifestylePremium = quotePricingService.calculatePersonalizedPremium(testProduct, lifestyleProfile);
    ...
    void calculatePersonalizedPremium_ShouldBeHigher_ForLowEngagement() {
        ...
        BigDecimal lowEngagementPremium = quotePricingService.calculatePersonalizedPremium(testProduct, lowEngagement);
        BigDecimal goodEngagementPremium = quotePricingService.calculatePersonalizedPremium(testProduct, goodEngagement);
    ...
    void calculatePersonalizedPremium_ShouldBeHigher_WithPreviousClaims() {
        ...
        BigDecimal noClaimsPremium = quotePricingService.calculatePersonalizedPremium(testProduct, noClaims);
        BigDecimal withClaimsPremium = quotePricingService.calculatePersonalizedPremium(testProduct, withClaims);
    ...
    void calculatePersonalizedPremium_ShouldBeHigher_ForMicroInfluencer() {
        ...
        BigDecimal microPremium = quotePricingService.calculatePersonalizedPremium(testProduct, microInfluencer);
        BigDecimal mediumPremium = quotePricingService.calculatePersonalizedPremium(testProduct, mediumInfluencer);
    ...
    void calculatePersonalizedPremium_ShouldNeverBeLessThanBase_WorstCase() {
        ...
        BigDecimal premium = quotePricingService.calculatePersonalizedPremium(testProduct, worstCase);
    ...
    void calculatePersonalizedPremium_ShouldBeSignificantlyHigher_WorstRiskProfile() {
        ...
        BigDecimal premium = quotePricingService.calculatePersonalizedPremium(testProduct, worstRisk);
    ...
    void calculateRiskScore_ShouldBeHigher_ForHighRiskProfile() {
        ...
        int highRiskScore = quotePricingService.calculateRiskScore(highRisk, testProduct);
        int lowRiskScore = quotePricingService.calculateRiskScore(lowRisk, testProduct);
